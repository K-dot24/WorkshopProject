...
namespace Terminal3.ServiceLayer.Controllers
{
    ...
    public class StoreStaffController : IStoreStaffInterface
    {
        ...
        public Result<ProductDAL> AddProductToStore(String userID, String storeID, String productName, double price, int initialQuantity, String category, LinkedList<String> keywords = null) { return StoresAndManagementInterface.AddProductToStore(userID, storeID, productName, price, initialQuantity, category,keywords); }
        ...
        public Result<ProductDAL> EditProductDetails(String userID, String storeID, String productID, IDictionary<String, Object> details) { return StoresAndManagementInterface.EditProductDetails(userID, storeID,  productID, details); }
        ...
        public Result<Dictionary<IStoreStaffDAL, PermissionDAL>> GetStoreStaff(String ownerID, String storeID) { return StoresAndManagementInterface.GetStoreStaff(ownerID, storeID); }
        public Result<HistoryDAL> GetStorePurchaseHistory(String ownerID, String storeID) { return StoresAndManagementInterface.GetStorePurchaseHistory(ownerID, storeID); }
