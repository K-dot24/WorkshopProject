...
namespace Terminal3.ServiceLayer.Controllers
{
    ...
    public class StoreStaffController : IStoreStaffInterface
    {
        ...
        public Result<Boolean> AddStoreOwner(String addedOwnerEmail, String currentlyOwnerID, String storeID) { return StoresAndManagementInterface.AddStoreOwner(addedOwnerEmail, currentlyOwnerID, storeID); }
        public Result<Boolean> AddStoreManager(String addedManagerEmail, String currentlyOwnerID, String storeID) { return StoresAndManagementInterface.AddStoreManager(addedManagerEmail, currentlyOwnerID, storeID); }
        ...
        public Result<Boolean> RemoveStoreManager(string removedManagerEmail, string currentlyOwnerID, string storeID) { return StoresAndManagementInterface.RemoveStoreManager(removedManagerEmail, currentlyOwnerID, storeID); }
        public Result<Boolean> RemoveStoreOwner(string removedOwnerEmail, string currentlyOwnerID, string storeID) { return StoresAndManagementInterface.RemoveStoreOwner(removedOwnerEmail, currentlyOwnerID, storeID); }
